...
module Quadbase
  class Application < Rails::Application
    ...
    config.active_record.observers = :question_role_request_observer
    ...
    # This enables recaptcha for the test and production environments
    config.enable_recaptcha = true

    # The timeout for the question locks when editing or publishing.
    # A timeout less than or equal to zero turns off the locking mechanism.
    # Note that the test environment overrides this variable
    # Example:
